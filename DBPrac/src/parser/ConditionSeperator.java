...
public class ConditionSeperator implements ExpressionVisitor {

	private Expression fullExpr;
	private Expression curExpr;
	// the list of schemas in one or two tables, for current conditions
	private ArrayList<String> tableScehmas;
	private HashMap<String,String> tableAlias;
//	private static ArrayList<String> binaryOps = [];
	
	
	
	public ConditionSeperator(Expression whereExpr,HashMap<String,String> tableAlias) {
		this.fullExpr=whereExpr;
		this.tableAlias = tableAlias;
		this.curExpr=new NullValue();
	}
	
	public Expression getCurrentCondition(ArrayList<String> tableSchemas) {
		this.tableScehmas=tableSchemas;
		fullExpr.accept(this);
		return this.curExpr;
	}
	...
	public boolean singleExpr(String a) {
		boolean sole =false;
