...
public class UnionFind {
	...
	/**
	 * 
	 * Example: WHERE S.A = S.B AND S.B = S.C AND S.D = 15
	 * Return: <[S.A, S.B, S.C]: [Null, Null]>, <[S.D]: [15,15]>
	 * @param alias
	 * @return
	 */
	...
	/**
	 * Example: " R.a=R.h=B.C  AND  S.d=B.e "    prevTables:[R,S]  topMostTable: [B]
	 * Return:  [ ["R.a","R.h" , "B.c"], ["S.d" , "B.e"] ]
	 * 
	 * @param tableList
	 * @param table2
	 * @return
